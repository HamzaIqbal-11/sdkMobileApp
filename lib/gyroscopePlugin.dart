...
class GyroscopePlugin {
  ...
  ///
  /// [gameId]          Game ka naam e.g. 'ball_tilt_game'
  /// [samplingRate]    Gyro speed (default: game ~60Hz)
  /// [autoLog]         Logcat mein print karo
  /// [onData]          Har gyro reading pe callback
  /// [onSessionStart]  Jab session shuru ho
  /// [onSessionStop]   Jab session band ho (backend data bhi milega)
  /// [onPhoneState]    Jab phone idle/active ho
  /// [wsUrl]           WebSocket URL (real-time streaming)
  /// [restApiUrl]      REST API URL (session end pe save)
  Future<String?> startGame({
    ...
    // Setup MethodChannel handler — native se callbacks sunna shuru karo
  ...
  /// Game band karo — session + gyroscope ek saath band ho jaate hain
